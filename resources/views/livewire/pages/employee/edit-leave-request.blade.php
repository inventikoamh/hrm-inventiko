        ...
        <div class="bg-white shadow rounded-lg">
            ...
            <form wire:submit="update" class="p-6 space-y-6">
                ...
                @if($isResubmit)
                    <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-yellow-800 font-medium">This request was previously rejected. You can resubmit it with additional notes.</span>
                        </div>
                    </div>
                @endif
                ...
                @if($isResubmit)
                    <!-- Resubmit Note -->
                    <div>
                        <label for="resubmitNote" class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <p class="text-sm text-gray-500 mt-1">This note will be added to your reason</p>
                    </div>
                @endif
